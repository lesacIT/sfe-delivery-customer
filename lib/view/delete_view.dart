              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(fontSize: 17, color: global.gold),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: global.gold, fontSize: 17),
                    ),
                  ),
                  Container(
                    decoration: BoxDecoration(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                              ...
                              style:
                                  TextStyle(color: global.gold, fontSize: 17)),
                        ),
                        Container(
                          width: 30,
                          height: 30,
                          decoration: BoxDecoration(
                            border: Border.all(color: global.gold, width: 1),
