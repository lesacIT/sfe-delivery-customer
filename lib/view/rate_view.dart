  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Danh sách đánh giá',style: TextStyle(color: global.gold, fontWeight: FontWeight.bold),),
        centerTitle: true,
        leading: InkWell(
          onTap: (){
            Get.back();
                        ...
                        child: InkWell(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: 'Từ ngày',
                                hintStyle: TextStyle(fontSize: 17, color: global.grey),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text('  '+listReview[index]['order_code'].toString(), style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: global.gold),),
                            ],
                          ),
                          Padding(
                            padding: EdgeInsets.fromLTRB(0, 10, 0, 10),
                            child: Text(listReview[index]['driver']['name'], style: TextStyle(color: global.gold,fontSize: 18,fontWeight: FontWeight.bold),),
                          ),
                          Padding(
                            ...
                            child: Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Đặt lúc: ', style: TextStyle(fontWeight: FontWeight.bold,color: global.gold,fontSize: 18,),),
                                Text(DateFormat('HH:mm dd/MM/yyyy').format(DateTime.parse(listReview[index]['order']['created_at'])), style: TextStyle(color: global.gold,fontSize: 18,),),
                              ],
                            ),
                          ),
